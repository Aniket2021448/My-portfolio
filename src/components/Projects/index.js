    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          <Divider />
          {toggle === 'core CS' ?
            <ToggleButton active value="core CS" onClick={() => setToggle('core CS')}>Core CS</ToggleButton>
            :
            <ToggleButton value="core CS" onClick={() => setToggle('core CS')}>Core CS</ToggleButton>
          }
          <Divider />
